...
#define LED3_OUT                (R32_PA_OUT)
#define LED4_OUT                (R32_PA_OUT)

#define LED1_DDR                (R32_PA_DIR |= LED1_BV)
#define LED2_DDR                (R32_PA_DIR |= LED2_BV)
#define LED3_DDR                (R32_PA_DIR |= LED3_BV)
#define LED4_DDR                (R32_PA_DIR |= LED4_BV)
...
extern void HalLedOnOff(uint8_t leds, uint8_t mode);
