...
def main():
    ...
    assert "#define WATER_ADC2_3_ANALOG_IE 0x4000" in pwr_c, "water detection must define the ADC2/3 analog input enable bit"
    ...
    assert "GPIOAGPPCfg(ENABLE, WATER_ADC2_3_ANALOG_IE);" in water_detect, "PA12 ADC2 analog input must be enabled"
